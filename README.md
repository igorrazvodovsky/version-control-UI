...
- `AGENTS.md` contains the Codex instructions for the repository.
- `specs/AGENTS.md` contains the Simple State Form (SSF) reference used when
  editing concept state in `specs/*.concept`.
- For non-Codex users, copy these files as system prompts. All files are basic
  markdown.
