...
- [x] Review existing gitless syncs, branch/commit concepts, and web article UI patterns
...
- [x] Backend: update /gitless/commits to merge branch into main; mark branch committed/hidden
...
- [x] Tests: update gitless sync tests + add history/change list tests
